...
TinyXMLResource& TinyXMLResource::operator=(const TinyXMLResource& rhs)
{
   ...
   if(rhs.mTinyXMLDoc.Error())
      mTinyXMLDoc.SetError(rhs.mTinyXMLDoc.ErrorId(),0,0,TIXML_ENCODING_UNKNOWN);
                                  ...
                                  const String& newGroup)
{
   ...
   // copy error id if occured
   if(mTinyXMLDoc.Error())
      newTinyXMLResource->mTinyXMLDoc.SetError(mTinyXMLDoc.ErrorId(),0,0,TIXML_ENCODING_UNKNOWN);
